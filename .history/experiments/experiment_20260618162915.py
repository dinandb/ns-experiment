...
def run_single_experiment(graph_size, run_i, alg):
    ...
    for i, n_graphs in enumerate(N_GRAPHS_LIST):
        ...
        nhmi_score, optimal_modularities, elapsed_times, cur_coph_sum = run_and_compare(
            graph_size,
            dend,
            n_graphs,
        ...
        # aan het einde van deze functie voeg toe aan records (key=(graph_size, run_i, alg) -> lijst[int] = no_edges, lijst[int] = no_comps)
