...
#       run all selected agglomorative algorithms (currently, there are none) -> return a merges list M'
#   
#       scoring function = HMI(M, M'), for each algorithm
#   compute average score for each algorithm on this dendrogram
# compute average score for each algorithm over all dendrograms.