...
from algorithms.divisive.clust_coef_divisive import ClusteringCoefficientDivisivefrom algorithms.divisive.clust_coef_divisive import ClusteringCoefficientDivisive
